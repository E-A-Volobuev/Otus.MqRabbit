...
public sealed class StartApp : BackgroundService
{
    ...
    public StartApp(IMassTransitHelper helper, IConsoleAction actionPrint, IProducerSettingService settingService)
    {
    ...
    {
        var task1 = _helper.ReceiveMessageAsync(MassTransitConstants.MassTransitConsumerQueueName);
    ...
    private async Task SendNumberAsync(SettingDto currentSettings, int attemptionNumber)
    {
        ...
        else
        {
            await _helper.SendMessageAsync(new MessageDto(number, currentSettings.Start,
                                                          ...
                                                          currentSettings.AttemptsCount, String.Empty, false),
                                           MassTransitConstants.MassTransitProducerQueueName);
